                    ...
                    {project.features?.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mb-5">
                        {project.features.slice(0, 3).map((f, idx) => (
                          <span key={idx} className="proj-tag text-white"
                            style={{ background: accentColor + "cc" }}>
                            {f}
                          </span>
                        ))}
                        {project.features.length > 3 && (
                          <span className="proj-tag text-gray-500 bg-gray-100">
              ...
              >
                ...
                <div className="p-7">
                  ...
                  {activeProject.features?.length > 0 && (
                    <>
                      <p className="text-xs font-bold tracking-widest text-gray-400 uppercase mb-3">Features</p>

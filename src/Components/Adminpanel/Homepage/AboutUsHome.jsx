...
import { useDispatch, useSelector } from "react-redux";
import {
  addAboutUsLocal,  // Changed from addAboutUs
  updateAboutUsLocal, // Changed from updateAboutUs
  deleteAboutUsLocal, // Changed from deleteAboutUs
  fetchAboutUs,      // Add this to fetch data from API
} from "../../store/HomepageSlices/AboutUsSlice";
...
const AboutUsHome = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (editIndex !== null) {
      dispatch(updateAboutUsLocal({ index: editIndex, updatedData: payload }));
      setEditIndex(null);
    } else {
      dispatch(addAboutUsLocal(payload));
    }
  ...
  /* DELETE */
  const handleDelete = (index) => {
    dispatch(deleteAboutUsLocal(index));
  };

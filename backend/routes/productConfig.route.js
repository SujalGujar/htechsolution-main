...
// router.get("/:categoryId/configurations", verifyToken,authorizeRoles("admin","manager"), getConfigByCategoryProduct);                  // Get config by category ID
router.get("/:categoryId/configurations", verifyToken, authorizeRoles("admin","manager"), getConfigByCategoryProduct);
